...
```
```{r}
featureMatrixMDI1 <- intensityMatrix(peaksMDI)
...
```
```{r}
 plot(MDI[[1]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
 points(peaksMDI1[[1]], col="red", pch=10)
  labelPlot("A")
 plot(MDI[[2]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
 points(peaksMDI1[[2]], col="red", pch=5)
  labelPlot("B")
  plot(MDI[[4]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
 points(peaksMDI1[[4]], col="red", pch=10)
  ...
  ## line types
  lty <- c(1, 4, 2, 6)
plot(MDI[[5]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
 points(peaksMDI1[[5]], col="red", pch=10)
 labelPlot("D")
 plot(MDI[[6]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
 points(peaksMDI1[[6]], col="red", pch=10)
 labelPlot("E")
 plot(MDI[[7]], lwd=0.25, sub="", main="", ylab="", xlab="",
       xlim=c(50,300))
